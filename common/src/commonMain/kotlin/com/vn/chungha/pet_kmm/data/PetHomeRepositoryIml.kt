package com.vn.chungha.pet_kmm.data
...
class PetHomeRepositoryIml(private val petApi: PetApi) : PetCatRepository {
  override suspend fun getPetCatByPage(query: String, page: Int, perPage: Int): List<PetCatResponse> =
    petApi.fetchPetHomeByBreedPage()
}
